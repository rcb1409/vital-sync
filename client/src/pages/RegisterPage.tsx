    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-primary p-4">
      <div className="glass rounded-2xl p-8 w-full max-w-md border border-border">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">Start optimizing your health today.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-text-secondary text-sm font-medium mb-1" htmlFor="name">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div>
            ...
            <input
              ...
              placeholder="Requires 8+ chars, 1 uppercase, 1 number"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-accent hover:bg-accent-hover text-white font-medium py-2.5 rounded-lg transition-smooth flex justify-center items-center h-[44px] mt-2"
          >
        ...
        <div className="mt-6 text-center text-sm text-text-muted">
          ...
          <Link to="/login" className="text-accent hover:text-accent-hover font-medium transition-smooth">
            Log in
          </Link>
        </div>
      </div>
